...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/ia-services`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/ra-services`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/investor-charter-ia`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.6 },
    { url: `${baseUrl}/investor-charter-ra`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.6 },
    ...
    { url: `${baseUrl}/mitc-ia`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.5 },
    { url: `${baseUrl}/mitc-ra`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.5 },

...
function verifyWebhookSignature(rawBody : string, signature : string, timestamp : string) {
   ...
   const secretKey = process.env.NODE_ENV === "production" ? process.env.CASHFREE_PAYMENT_GATEWAY_IA_LIVE_SECRET : process.env.CASHFREE_PAYMENT_GATEWAY_IA_TEST_SECRET;

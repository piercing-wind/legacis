...
import { deleteResearchAdvisoryStock, upsertResearchAdvisoryStocks } from "@/actions/admin/services";
import { callTypeOptions, ResearchAdvisoryStocksFormSchema, statusOptions } from "@/lib/schema";
  ...
  initialServiceId
   ...
   async function handleSubmit(values: StocksFormValues) {
      ...
      try {
         ...
         const result = await upsertResearchAdvisoryStocks({ stocks: stocksToUpsert });
                  ...
                  <Dialog>
                     ...
                     <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                           ...
                           <DialogDescription>
                           This action cannot be undone. This will permanently delete stock
                           ...
                           <Button
                              ...
                              onClick={async () => {
                                 ...
                                 try {
                                    ...
                                    const res = await deleteResearchAdvisoryStock(stockId);
                                    if (!res.success) {

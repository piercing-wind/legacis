...
interface PlatinaPieChartProps {
  data: PieChartDataPoint[],
  chartConfig: ChartConfig;
}

export default function PlatinaPieChart({ data, chartConfig }: PlatinaPieChartProps) {
  ...
  return (
    <div className="w-full">
      <ChartContainer config={chartConfig} className="w-full min-h-72 md:min-h-52 p-4">
          <RechartsePieChart>
            <Pie
              data={data}
              cx="50%"
